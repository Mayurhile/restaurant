...
function displayItems(){
    ...
    friesData.map(item=>{
        ...
        frenchfries.appendChild(itemCard)
...
const servecies = fs.readFileSync('./services.html')
